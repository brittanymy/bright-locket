            ...
            <div className="home__container container grid">
                <div className="home__content grid">
                    <div className="home__social">
                        <a href="https://www.linkedin.com/in/brittany-young-35a35a22a/" target="_blank" rel="noreferrer" className="home__social-icon">
                        ...
                        <a href="https://github.com/brittanymy" target="_blank" rel="noreferrer" className="home__social-icon">
                    ...
                    <div className="home__data">
                        <h1 className="home__title">Hi, I'm Brittany</h1>
                        <h3 className="home__subtitle">I'm a Software Engineer</h3>
                        <p className="home__description">North Carolina based, full-stack web developer.</p>
